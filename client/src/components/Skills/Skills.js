        ...
        <Container>
          <Row>
            <Col className="ml-auto mr-auto" md="8">
              <h2 className="title">Well, wanna know my products Knowledge?</h2>
            ...
            <Col md="3">
              <div className="info">
                ...
                <div className="description">
                  ...
                  <Button className="btn-link" color="info" href="https://www.codechef.com/users/aniket4064" target="_blank">Codechef</Button>
                  <br/>
            ...
            <Col md="3">
              <div className="info">
                ...
                <div className="description">
                  ...
                  <p>
                    <strong>C</strong>  <br/>
                    <strong>Java</strong> (Proficient) <br/>
                    <strong>Javascript</strong> <br/>
                    <strong>Typescript</strong> <br/>
                    <strong>Python</strong> (Novice) <br/>
